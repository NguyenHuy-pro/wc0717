...
@section('wc_m_contain_action_wrap')
    <div id="wc_m_content_action"
         class="col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1 wc-position-abs wc-zindex-2 wc-margin-top-40 wc-border-radius-10 wc-padding-none wc-bg-white wc-overflow-auto">
