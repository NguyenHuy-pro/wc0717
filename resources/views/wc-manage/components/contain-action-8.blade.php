...
@section('wc_m_contain_action_wrap')
    <div id="wc_m_content_action"
         class="col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2 wc-position-abs wc-zindex-2 wc-margin-top-40 wc-border-radius-10 wc-padding-none wc-bg-white wc-overflow-auto">
